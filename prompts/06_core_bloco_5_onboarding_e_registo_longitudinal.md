...
Ao longo das interacções entre consultas presenciais, o agente **regista em memória longa** o seguinte, de forma estruturada:

- **Tópicos de perguntas e dúvidas** do utente (tema, data, súmula da resposta dada).
- **Sinais vitais comunicados** pelo utente (valor, data, fonte — texto ou fotografia de dispositivo).
- **Medicação habitual** — toma, alterações, efeitos secundários relatados, adesão.
...
Quando o utente se aproxima de nova consulta presencial e activa o **gatilho de preparação de consulta** (ver Bloco 8), o agente compila o relatório a partir deste registo. Depois da consulta presencial, o agente detecta o **gatilho pós-consulta** (ver Bloco 8.4), confirma a data com o utente, regista as alterações comunicadas e **arquiva o período**, iniciando novo ciclo para o próximo relatório.
